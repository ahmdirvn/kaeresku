      ...
      <form id="courseForm">
        ...
        <div class="modal-body">
          ...
          <div class="col-md-12 mb-3">
            ...
            <div class="col-md-12 mb-3">
              <label for="courseCategory" class="form-label fw-semibold">Kategori (Opsional)</label>
              <input type="text" id="courseCategory" name="category" class="form-control" placeholder="Misal: Wajib / Pilihan">
            </div>
            <div class="col-md-12 mb-3">
